...
I'm an engineering student at **Thapar Institute of Engineering & Technology (ECED)**, focused on **backend engineering, AI-powered applications, and 3D computer vision**. My background started in **C**, and I'm now building toward a Python-first stack for backend + AI systems.
...
| 🗂️ Loader design | Dynamic multi-frame `SemanticKITTILoader` |
